...
class EquipmentItemWidget(QWidget):
    def __init__(self, equipment_data, employee_window):
        ...
        self.info_label.setStyleSheet("color: #333; font-size: 11pt;")
...
class RequestItemWidget(QWidget):
    def __init__(self, request_data, tech_window):
        ...
        info_label.setStyleSheet("color: #333; font-size: 11pt;")
...
class EmployeeWindow(BaseWindow):
    ...
    def setup_content_ui(self):
        ...
        self.type_combo.setStyleSheet("font-size: 11pt; padding: 5px;")
        self.id_input = QLineEdit()
        self.id_input.setPlaceholderText("Инвентарный ID оборудования")
        self.id_input.setStyleSheet("font-size: 11pt; padding: 5px;")
...
class TechAdminCreationWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.username_edit.setStyleSheet("font-size: 11pt; padding: 10px; border-radius: 5px;")

        self.password_edit = QLineEdit()
        self.password_edit.setPlaceholderText("Пароль нового техника")
        self.password_edit.setEchoMode(QLineEdit.EchoMode.Password)
        self.password_edit.setFixedHeight(40)
        self.password_edit.setStyleSheet("font-size: 11pt; padding: 10px; border-radius: 5px;")
